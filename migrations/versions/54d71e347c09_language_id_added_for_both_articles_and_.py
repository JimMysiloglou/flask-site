...
def upgrade():
    ...
    op.add_column('article', sa.Column('language_id', sa.String(length=2), nullable=False))
    op.add_column('project', sa.Column('language_id', sa.String(length=2), nullable=False))
